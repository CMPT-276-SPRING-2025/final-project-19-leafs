...
function handleLogin() {
    ...
    if (!user) {
        errorElement.textContent = 'User not found. Please check your email or sign up';
        return;
    }
...
function handleSignup() {
    ...
    if (users.some(user => user.email === email)) {
        errorElement.textContent = 'Email already in use. Please use a different email or login';
        return;
    }
